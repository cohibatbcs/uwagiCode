...
<div id=contentDiv>
	...
	<div id=adHeaderDiv>
    	<b>When you submit this form, a random key will be sent to your cell phone for verification purposes.<br>Be prepared to enter that key on the next page.</b>
    </div>
...
print "<br>";
print "<form name=triviaPasswordReset action=triviaForgotPasswordSessions.php method=post>";
