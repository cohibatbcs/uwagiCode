...
<script type="text/javascript">
        konami = new Konami()
        konami.load("http://www.uwagibox.com/konami");
</script>
...
//     print "<a href=$menuLink[5].php target=contentFrame>$menuText[5]</a>";
    ...
    <a href=clientLogin.php>client page</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id=blackFooter>
		<table border="0" bgcolor="#000000"  cellpadding="0" cellspacing="0" height="45" width="1025" align="center">
        	<tr>
                <td width="1025" align="center" valign="bottom">
                	<a href="mailto:info@uwagibox.com">info@uwagibox.com</a>&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;333 N Commercial St. Ste. 200&nbsp;&nbsp;&nbsp;Neenah, WI 54956&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;p(920) 886-2530&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;f(920) 886-2540<br />
                    <br />
                	<font size="-2" color="#CCCCCC">© 2011 Uwagi, LLC. All Rights Reserved.</font>
                </td>
			</tr>
        </table>
	</div>
