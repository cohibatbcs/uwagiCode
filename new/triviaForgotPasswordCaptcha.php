...
$captchaSent = $_POST['captchaSent'];
		...
		if (!isset($captchaSent)) {			
			print "<form name=captchaCheck action=triviaForgotPasswordCaptcha.php method=post>";
			...
			print "</form>";
?>
				<iframe src="http://184.60.94.154/captia.php?captia=<?php echo $captcha; ?>&cell=<?php echo $cell1;?>" width="1" height="1" scrolling="no" frameborder="0">
...
<?php
		...
		elseif ($captchaSent !== $captcha) {
			...
			print ("<script>location.href='triviaForgotPasswordSubmit.php'</script>");
		}
