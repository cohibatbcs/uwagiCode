...
<!--	START jQuery to make Checkboxes into Green/Red images	-->
...
<!--	START Javascript to enable CheckAll/UnCheckAll buttons on form	-->
<!--<script language='JavaScript'>
	...
	function checkedAll () {
		...
		for (var i = 0; i < document.getElementById('Schedule').elements.length; i++) {
			document.getElementById('Schedule').elements[i].checked = checked;
			$.uniform.update();
		}
	}
</script>-->
...
?>
  ...
  <!--  <div id="adHeaderDiv">
    ...
    <div id="contentDiv"> 
    	<form name="adSchedule" id="Schedule" action="clientAdSchedulingScript.php" method="post">
	...
	<div id="adScheduleDescDiv">
        ...
        <br />
<!--        <BR>Enable/Disable All Ads: <input type='checkbox' name='checkall' onclick='checkedAll();'>-->
    </div>
