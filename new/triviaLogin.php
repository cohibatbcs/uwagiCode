...
//				print "</div>";
				...
				print "<div id=mainTriviaBody>";
					print "Having trouble finding something to talk about with your date? Need something to do while you wait for your friends?<br>";
					print "<br>";
					...
					print "<font color=#FF0000><b>Caution</b> - <i>Uwagi is not responsible for callused or 'gaming thumbs' due to the addicting nature of Uwagi's text messaging based Trivia.</i></font><br>";
					print "<br>";
					...
					print "<table border=0 cellpadding=2 cellspacing=0 width=480>";
						...
						print "<tr>";
							print "<td align=right width=30%></td>";
							print "<td align=left width=70%>Forgot your password? <a href=triviaForgotPassword.php>Reset my password.</a></td>";
						print "</tr>";
					print "</table>";
					print "</form>";
				print "</div>";			
